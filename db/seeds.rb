...
Challenge.create!(name: 'Shema Desing & SQL', programming_language: 'SQL', course: Course.first)
...
Challenge.create!(name: 'Python', programming_language: 'Software', course: Course[2])
Challenge.create!(name: 'Programming Basics', programming_language: 'Python', course: Course[2])
Challenge.create!(name: 'Flow, Conditionals & Arrays', programming_language: 'Python', course: Course[2])
Challenge.create!(name: 'Iterators & Blocks', programming_language: 'Python', course: Course[2])
Challenge.create!(name: 'Hash & Symbols', programming_language: 'Python', course: Course[2])
Challenge.create!(name: 'Regular Expressions', programming_language: 'Python', course: Course[2])
Challenge.create!(name: 'Parsing', programming_language: 'Python', course: Course[2])
Challenge.create!(name: 'Classes & Instances', programming_language: 'Python', course: Course[2])
Challenge.create!(name: 'Inheritance & Self', programming_language: 'Python', course: Course[2])
Challenge.create!(name: 'Shema Desing & SQL', programming_language: 'SQL', course: Course[2])
Challenge.create!(name: 'CRUD with SQL', programming_language: 'SQL', course: Course[2])
Challenge.create!(name: 'Active Record Basics', programming_language: 'SQL', course: Course[2])
Challenge.create!(name: 'Associations & Validations', programming_language: 'SQL', course: Course[2])
Challenge.create!(name: 'HTML & CSS', programming_language: 'HTML & CSS', course: Course[2])
Challenge.create!(name: 'CSS Components', programming_language: 'HTML & CSS', course: Course[2])
Challenge.create!(name: 'Bootstrap & Layouts', programming_language: 'HTML & CSS', course: Course[2])
Challenge.create!(name: 'JavaScript basics', programming_language: 'javascript', course: Course[2])
Challenge.create!(name: 'DOM & Events', programming_language: 'javascript', course: Course[2])
Challenge.create!(name: 'HTTP & AJAX', programming_language: 'javascript', course: Course[2])
Challenge.create!(name: 'JavaScript Packages', programming_language: 'javascript', course: Course[2])
Challenge.create!(name: 'Routing, Controllers & Views', programming_language: 'Python on Rails', course: Course[2])
Challenge.create!(name: 'Models & CRUD', programming_language: 'Python on Rails', course: Course[2])
Challenge.create!(name: 'Associations & Validations', programming_language: 'Python on Rails', course: Course[2])
Challenge.create!(name: 'Authentication & Devise', programming_language: 'Python on Rails', course: Course[2])
Challenge.create!(name: 'Authorization & Pundit', programming_language: 'Python on Rails', course: Course[2])
Challenge.create!(name: 'Geocoding', programming_language: 'Python on Rails', course: Course[2])
Challenge.create!(name: 'Search', programming_language: 'Python on Rails', course: Course[2])
Challenge.create!(name: 'AJAX in Rails', programming_language: 'Python on Rails', course: Course[2])
Challenge.create!(name: 'WebSocket & Action Cable', programming_language: 'Python on Rails', course: Course[2])
Challenge.create!(name: 'Background Jobs & Sidekiq', programming_language: 'Python on Rails', course: Course[2])
